  ...
  return (
    <>
      <section
        ...
        className="min-h-[600px] bg-cover lg:bg-fixed bg-[77%] sm:bg-center bg-no-repeat text-white grid place-items-center"
      >
        <div className="grid place-items-center max-w-[650px] text-center gap-3 px-5">
          ...
          <span className="">
            Chúng tôi tin rằng thời trang không chỉ là những gì bạn mặc, mà còn
            là cách bạn thể hiện bản thân và kể câu chuyện của mình.
          </span>
        </div>
      </section>
      <section className="w-full md:w-[730px] lg:w-[950px] xl:w-[1160px] mx-auto pt-24 px-4">
        <div className="w-full grid lg:grid-cols-[500px_auto] gap-x-4">
          <div className="grid">
            ...
            <span>
              Được thành lập với niềm đam mê thời trang hiện đại, FabricFocus
              cam kết cung cấp trang phục độc đáo.
            </span>
          </div>
          <div className="grid gap-y-4 text-[#888] text-sm">
            <span>
              Tại FabricFocus, chúng tôi chú ý đến từng chi tiết nhỏ để đảm bảo
              rằng mỗi sản phẩm đều hoàn hảo khi đến tay bạn. Từ việc chọn vải
              và màu sắc đến đường may, chúng tôi cam kết mang lại sự thoải mái
              và độ bền. Trong nỗ lực theo đuổi thời trang bền vững, chúng tôi
              chọn các vật liệu thân thiện với môi trường, để sản phẩm của chúng
              tôi không chỉ làm bạn trông đẹp mà còn góp phần vào một hành tinh
              tốt đẹp hơn.
            </span>
            <span>
              Cho dù bạn thích phong cách thanh lịch, năng động hay tối giản,
              chúng tôi đều có những thiết kế phù hợp với bạn. Sứ mệnh của
              FabricFocus là giúp bạn cảm thấy tự tin trong mọi khoảnh khắc, dù
              bạn đang đi dạo trên phố, làm việc tại văn phòng hay tham dự một
              sự kiện đặc biệt.
            </span>
          </div>
        </div>
      ...
      <section
        className={`w-full md:w-[730px] lg:w-[950px] xl:w-[1160px] mx-auto pt-24 px-4`}
      >
        <SlideShow />
      </section>
      <section
        className={`max-w-[1408px] mx-auto pt-[140px] px-4 flex flex-col gap-y-16`}
      >
      ...
      <section
        className={`w-full md:w-[730px] lg:w-[950px] xl:w-[1160px] mx-auto pt-[140px] px-4 flex flex-col gap-y-16`}
      >
        <div className="grid place-items-center max-w-[650px] text-center gap-3 px-5 mx-auto">
        ...
        <div className="Client_Logo grid grid-cols-2 grid-rows-5 md:grid-cols-4 md:grid-rows-3 lg:grid-cols-5 lg:grid-rows-2 *:border *:-mt-[1px] *:-mr-[1px]">
          <Link to="">
            <div className="group relative overflow-hidden place-items-center">
              <img
                className="transition-all duration-500 translate-y-0 group-hover:-translate-y-full"
                src="/images/client-logo-1.jpg"
                alt="client_logo_1"
              />
              <img
                className="absolute top-0 left-1/2 -translate-x-1/2 transition-all duration-500 translate-y-full group-hover:translate-y-0"
                src="/images/client-logo-2.jpg"
                alt="client_logo_2"
              />
            </div>
          </Link>
      ...
      <section
        className={`w-full md:w-[730px] lg:w-[950px] xl:w-[1160px] mx-auto pt-[140px] px-4 grid`}
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center">
          <div className="hidden lg:block">
            <img src="/images/background-25.jpg" alt="bg_25" />
          </div>
          <div className="flex flex-col gap-x-4 gap-y-14">
            <div className="Title grid gap-y-3">
              ...
              <span className="text-[#555]">
                Tại FabricFocus, chúng tôi tạo ra những thiết kế độc đáo kết hợp
                phong cách hiện đại và sự thoải mái. Mỗi sản phẩm đều được chăm
                chút tỉ mỉ từ chất liệu đến đường may, mang đến trải nghiệm thời
            ...
            <div className="Content_Feel grid gap-y-7 mb-6 lg:mb-0">
              <div className="flex gap-x-3 md:gap-x-6">
                ...
                <div className="flex flex-col justify-center gap-y-3 text-sm">
                  ...
                  <span className="text-[#555]">
                    Tôi cũng rất buồn và bóng rổ. Bệnh tật hay bệnh tật không
                    cần chăm sóc dễ dàng. Dịch vụ khách hàng phải luôn đi trước
                    xe cộ
                  </span>
                </div>
              </div>
