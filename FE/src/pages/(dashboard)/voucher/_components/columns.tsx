...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      } else return <>{formatCurrency(row.getValue("discount"))} VNĐ</>;
    },
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="text-center">
          <Sheet>
            <SheetTrigger className="border rounded-md p-1 transition-all duration-300 hover:border-orange-400 hover:text-orange-400">
              <Eye size={20} />
            </SheetTrigger>
            <SheetContent>
              <SheetHeader>
